             ...
             <table class="table table-bordered">
                ...
                <tbody>
                   ...
                   <tr>
                      ...
                      <td>{{$order->currency_symbol_position == 'left' ? $order->currency_symbol : ''}}{{$item->price}}{{$order->currency_symbol_position == 'right' ? $order->currency_symbol : ''}}</td>
                      <td>{{$order->currency_symbol_position == 'left' ? $order->currency_symbol : ''}}{{$item->price * $item->qty}}{{$order->currency_symbol_position == 'right' ? $order->currency_symbol : ''}}</td>
                   </tr>
                   @endforeach
                </tbody>
             </table>
