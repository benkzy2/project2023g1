            ...
            <a href="{{route('admin.popup.create') . '?type=1'}}" class="d-block">
                <div class="card card-stats">
                    <div class="card-body ">
                        ...
                        <h5 class="text-center text-white mt-2 mb-0">Type - 1 <span class="d-block mt-1 text-warning">Only Image</span></h5>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="{{route('admin.popup.create') . '?type=2'}}" class="d-block">
                <div class="card card-stats">
                    <div class="card-body ">
                        ...
                        <h5 class="text-center text-white mt-2 mb-0">Type - 2 <span class="d-block mt-1 text-warning">Text + Background Image</span></h5>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="{{route('admin.popup.create') . '?type=3'}}" class="d-block">
                <div class="card card-stats">
                    <div class="card-body ">
                        ...
                        <h5 class="text-center text-white mt-2 mb-0">Type - 3 <span class="d-block mt-1 text-warning">Newsletter + Background Image</span></h5>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="{{route('admin.popup.create') . '?type=4'}}" class="d-block">
                <div class="card card-stats">
                    <div class="card-body ">
                        ...
                        <h5 class="text-center text-white mt-2 mb-0">Type - 4 <span class="d-block mt-1 text-warning">Text + Left Image</span></h5>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="{{route('admin.popup.create') . '?type=5'}}" class="d-block">
                <div class="card card-stats">
                    <div class="card-body ">
                        ...
                        <h5 class="text-center text-white mt-2 mb-0">Type - 5 <span class="d-block mt-1 text-warning">Newsletter + Left Image</span></h5>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="{{route('admin.popup.create') . '?type=6'}}" class="d-block">
                <div class="card card-stats">
                    <div class="card-body ">
                        ...
                        <h5 class="text-center text-white mt-2 mb-0">Type - 6 <span class="d-block mt-1 text-warning">Countdown + Background Image</span></h5>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="{{route('admin.popup.create') . '?type=7'}}" class="d-block">
                <div class="card card-stats">
                    <div class="card-body ">
                        ...
                        <h5 class="text-center text-white mt-2 mb-0">Type - 7 <span class="d-block mt-1 text-warning">Countdown + Left Image</span></h5>
                    </div>
                </div>
            </a>
        </div>
