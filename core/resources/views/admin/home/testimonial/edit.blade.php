        ...
        <div class="card-body pt-5 pb-5">
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              ...
              <form id="ajaxForm" class="" action="{{route('admin.testimonial.update')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <div class="col-md-12 showImage mb-3">
                        <img src="{{ $testimonial->image ? asset('assets/front/img/testimonials/'.$testimonial->image) : asset('assets/admin/img/noimage.jpg')}}" alt="..." class="img-thumbnail">
                      </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control ltr" name="rating" value="{{$testimonial->rating}}" placeholder="Enter rating">
