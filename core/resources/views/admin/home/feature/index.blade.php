                    ...
                    <tbody>
                      @foreach ($features as $key => $feature)
                        <tr>
                          ...
                          <td><img src="{{asset('assets/front/img/features/'.$feature->image)}}" alt="" width="50"></td>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="ajaxForm" class="modal-form" action="{{route('admin.feature.store')}}" method="post" enctype="multipart/form-data">
            @csrf
