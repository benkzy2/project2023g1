<div>
    ...
    <div class="banner-area bg_cover d-flex align-items-center" data-parallax="scroll" data-speed="0.2" data-image-src="{{!empty($be->hero_bg) ? asset('assets/front/img/'.$be->hero_bg) : ''}}">
        <div class="container">
            <div class="row">
