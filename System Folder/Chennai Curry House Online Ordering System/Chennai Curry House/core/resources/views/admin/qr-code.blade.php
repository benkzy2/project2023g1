              ...
              <form id="qrGeneratorForm" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                      ...
                      <select name="style" class="form-control" onchange="generateQr()">
                          ...
                          <option value="square" {{$be->qr_style == 'square' ? 'selected' : ''}}>Square</option>

                          <option value="round" {{$be->qr_style == 'round' ? 'selected' : ''}}>Round</option>
                  ...
                  <div class="form-group">
                      ...
                      <select name="eye_style" class="form-control" onchange="generateQr()">
                          ...
                          <option value="square" {{$be->qr_eye_style == 'square' ? 'selected' : ''}}>Square</option>

                          <option value="circle" {{$be->qr_eye_style == 'circle' ? 'selected' : ''}}>Circle</option>
    ...
    <div class="col-lg-5">
        <div class="card bg-white">
            ...
            <div class="card-footer text-center" style="border-top: 1px solid #ebecec!important;">
              <a id="downloadBtn" class="btn btn-success" download="qr-image.png" href="{{asset('assets/front/img/' . $be->qr_image)}}">Download Image</a>
            </div>
        </div>
